                            ...
                            <td align='left' valign='middle' width="200">
                              <div class="contentEditableContainer contentImageEditable">
                                <div class="contentEditable" >
                                  <img src="https://www.adrun.re/wp-content/uploads/2017/09/Logo_adrun_bis.png" alt='Compagnie logo' data-default="placeholder" data-max-width="300" width='118' height='21' >
                                </div>
                              </div>
                            </td>
                    ...
                    <td width='500'>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top'>
                        <tr>
                          <td align='center'>
                            <div class='contentEditableContainer contentTextEditable'>
                              <div class='contentEditable'>
                                <h1 style='font-size:32px;'>Campagne en Cour
                                </h1>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td align='center'>
                            <div class='contentEditableContainer contentTextEditable'>
                             <div class='contentEditabler'>
							 <p>Nom: Sogecore</p>
							 <p>Début/Fin campagne: 
							 <ul>
							 <li>interstitiel MD TR - 18-10-2017 -> 27-10-2017</li>
							 <li>2509-SEAT IBIZA - 18-10-2017 -> 27-10-2017<</li>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top'>
                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <p style=' font-weight:bold;font-size:13px;line-height: 30px;'>ADRUN - REGIE WEB</p>
                                    </div>
                                  </div>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <p style='color:#A8B0B6; font-size:13px;line-height: 15px;'>REUNION</p>
                                    </div>
                                  </div>
                          ...
                          <td valign='top' valign="top" style="padding:0 20px 0 20px;">
                              <div class="contentTextEditable contentEditableContainer">
                                  <div class="contentEditable">
                                      ...
                                      <p style='text-align:right;margin:0;font-family:Georgia, serif;'><a target='_blank' href='#' class='link2' style='color:#ffffff;'>Read more →</a></p>
                                      <br>
                                      <br>
                                  </div>
                              </div>
