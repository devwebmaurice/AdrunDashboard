...
<h3 class="page-title">@lang('global.editeur.title')</h3>
    ...
    {!! Form::model($editeur, ['method' => 'PUT', 'route' => ['admin.editeur.update', $editeur->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('ciblage[]', $ciblages, old('ciblage') ? old('ciblage') : $edit_ciblages, ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
